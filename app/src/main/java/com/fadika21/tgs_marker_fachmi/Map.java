package com.fadika21.tgs_marker_fachmi;
...
public class Map extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.invalidate();
        startMarker1.setIcon(getResources().getDrawable(R.drawable.marker1));
        ...
        map.invalidate();
        startMarker2.setIcon(getResources().getDrawable(R.drawable.marker2));
        startMarker2.setTitle("UBL Pascasarjana");
        ...
        map.invalidate();
        startMarker3.setIcon(getResources().getDrawable(R.drawable.marker3));
        ...
        map.invalidate();
        startMarker4.setIcon(getResources().getDrawable(R.drawable.marker4));
        startMarker4.setTitle("Mall bumi Kedaton");

        GeoPoint startPoint5 = new GeoPoint(-5.381268, 105.249640);
        ...
        map.invalidate();
        startMarker5.setIcon(getResources().getDrawable(R.drawable.marker5));
